namespace OpenDataRdwNL.Models.ApiResponses
{
    public class CarFuelTypeDetailApiResponse
    {
        ...
        public string brandstofverbruik_buiten_de_stad { get; set; }
        ...
        public int emissie_deeltjes_type1_wltp { get; set; }
        public int emissie_co2_gecombineerd_wltp { get; set; }
        public int emissie_co2_gewogen_gecombineerd_wltp { get; set; }
        ...
        public int opgegeven_maximum_snelheid { get; set; }
